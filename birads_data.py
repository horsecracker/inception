...
tf.app.flags.DEFINE_string('data_dir','/scratch1/liliyu/cancer/inception/birads_dataset/processed/',
...
class BiradsData(Dataset):
  ...
  def __init__(self, subset):
    super(BiradsData, self).__init__('BIRADS', subset)
  ...
  def num_examples_per_epoch(self):
    ...
    if self.subset == 'train':
      return 4145        ###################### don't know what to use here
    if self.subset == 'validation':
      return 958        ###################### don't know what to use here
